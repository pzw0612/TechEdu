 ...
 */
public class WnPnPolyEn {

	public static void main(String[] args) {
		 
		Long startTime = System.currentTimeMillis();
		
		System.out.println(check(new Point(10,35),data2()));
		
		System.out.println("used time=" +  (System.currentTimeMillis()- startTime));
	}
	
	static boolean check(Point point , List<Point> paralist){
		 int    wn = 0;
		 
		 List<Point> list = PolySplit4Exclusive.cloneList(paralist);
